  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        ...
        >
          <GrayTitle>Ignite your ideas</GrayTitle>
          <br />
          <PinkTitle>into real-world solutions.</PinkTitle>
        </h1>

        <p className="mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-white/50 z-10">
          Describe your vision. Supernova handles the rest. We instantly
          translate your ideas into clean, functional code and impactful
          applications.
        </p>
        ...
        <div className="relative mx-auto mt-12 w-full max-w-2xl">
          ...
          >
            <textarea
              ...
              rows={1}
              className="w-full resize-none bg-transparent px-5 pb-4 pt-5 text-sm text-white placeholder:text-white/20 focus:outline-none sm:text-base caret-pink-400"
      ...
      <section className="px-4 pb-32">
        <div className="mx-auto mb-14 max-w-5xl text-center">
          ...
          <SectionHeading gray="From prompt" pink="to production." />
        </div>
          ...
          {FEATURES.map(({ icon: Icon, label, desc }) => (
            ...
            >
              <div className="mb-4 flex h-9 w-9 items-center justify-center rounded-lg border border-white/8 bg-white/4 group-hover:border-white/15 group-hover:bg-white/8">
                <Icon className="h-4 w-4 text-white/60 group-hover:text-pink-400/70" />
              </div>
      ...
      <section className="px-4 pb-32">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <SectionHeading gray="Four steps" pink="to a working app." />
        </div>
